...
while True:
    ...
    elif ventana_actual == "estadisticas":
        ventana_actual = mostrar_estadisticas(pantalla, cola_eventos)
    
    elif ventana_actual == "agregar_pregunta":
        ventana_actual = mostrar_pantalla_agregar_pregunta(pantalla, cola_eventos)
